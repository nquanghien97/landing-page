              ...
              >
                <NavLink href={`/san-pham/${product.slug}`}>
                  <div className="overflow-hidden">
                    <Image src={product.images[0].imageUrl} alt={product.name} width={100} height={100} className='w-full md:w-[300px] group-hover:scale-110 duration-500' layout='responsive' />
                  </div>
                  <div className='py-2'>
