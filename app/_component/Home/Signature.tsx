    ...
    <section className="md:py-7 max-md:px-4">
      <div className="max-w-6xl m-auto flex flex-col">
        ...
        <div className="text-center mb-4">
          <p className="font-bold text-justify">MỘC ĐƠN là kết quả của hành trình tìm kiếm và phát triển từ các thảo dược tự nhiên quý hiếm, được kết hợp bởi những tinh hoa của Y Học Cổ Truyền và Công Nghệ Hiện Đại. Mỗi viên Mộc Đơn đều mang trong mình sứ mệnh giúp phụ nữ vượt qua nỗi lo về U XƠ, U NANG, U LÀNH TÍNH, để họ có thể sống trọn vẹn hơn, tự tin hơn.</p>
        </div>
        <div className=''>
          <Swiper
            slidesPerView={1}
