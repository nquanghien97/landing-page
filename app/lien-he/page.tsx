                  ...
                  <div className="flex flex-col md:flex-row border-4 px-4 py-2 rounded-md border-[#81811b]">
                    <div className="flex flex-col items-center justify-center">
                      ...
                      <div className="flex justify-center">
                        <p className="text-base md:text-xl font-bold text-center mr-2">{StaffType[staff.type as keyof typeof StaffType]} bởi UNA Mộc Đơn chính hãng</p>
                    ...
                    <div className="md:ml-4 max-md:flex justify-center max-md:mt-4">
                      <Image src="/banner-profile.webp" alt="banner" width={200} height={200} />
                    </div>
                  </div>
                )}
                {staff.type === 'BANK' && (
